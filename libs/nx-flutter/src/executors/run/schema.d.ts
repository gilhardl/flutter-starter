 ...
 *
 * These are specific options passed to the `flutter run` command.
 */
export interface FlutterRunExecutorOptions extends FlutterExecutorOptions {
  /**
   ...
   */
  dumpSkpOnShaderCompilation: boolean;
   ...
   */
  skiaDeterministicRendering: boolean;
   ...
   */
  awaitFirstFrameWhenTracing: boolean;
