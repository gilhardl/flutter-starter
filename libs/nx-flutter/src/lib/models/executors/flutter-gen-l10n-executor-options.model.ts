...
/**
 * Normalized options passed to the `flutter gen-l10n` command.
 */
export interface FlutterGenL10nExecutorOptionsNormalized
   ...
   */
  untranslatedMessagesFile: string | null;
   ...
   */
  useDeferredLoading: boolean | null;
   ...
   */
  genInputsAndOutputsList: string | null;
   ...
   */
  requiredResourceAttributes: boolean | null;
